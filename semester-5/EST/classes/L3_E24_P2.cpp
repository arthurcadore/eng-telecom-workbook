...
int main()
{
    ...
    // número de homens que preferem salada
    int num_homens_saladas = 0; 
    ...
    for (int i = 0; i < num_clientes; i++)
    {
        ...
        if (teste_genero)
        {
            ...
            // se o homem preferir salada
            if (prefere_salada)
                //  atualiza o número de homens que preferem salada
                num_homens_saladas++;
        }
    ...
    // calcula as probabilidades a partir dos dados de teste frequentistas
    double pH = (double) num_homens / num_clientes;
    double pA_H = (double) num_homens_saladas / num_homens;
    double pB_H = 1 - pA_H;
