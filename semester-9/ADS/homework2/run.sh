...
# Link configurations
sudo vlink -bw $BANDWIDTH -dly $DELAY router1:pc1@$SCENARIO_ID
sudo vlink -bw $BANDWIDTH -dly $DELAY router1:pc3@$SCENARIO_ID
sudo vlink -bw $BANDWIDTH -dly $DELAY router2:pc2@$SCENARIO_ID
sudo vlink -bw $BANDWIDTH -dly $DELAY router2:pc4@$SCENARIO_ID
sudo vlink -bw $BANDWIDTH -dly $DELAY router2:router1@$SCENARIO_ID
